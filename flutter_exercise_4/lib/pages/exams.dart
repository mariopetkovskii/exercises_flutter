...
class _MyAppState extends State<MyApp> {
  ...
  void initState() {
    ...
    exams.add(Exam(id: "0", subject: "WP", datetime: DateTime(2022, 6, 6), time: TimeOfDay(hour: 11, minute: 00), duration: 1));
    exams.add(Exam(id: "1", subject: "EMT", datetime: DateTime(2022, 7, 1), time: TimeOfDay(hour: 12, minute: 00), duration: 1));
