...
import 'package:flutter_exercise_4/widgets/calendar.dart';
import 'package:flutter_exercise_4/widgets/map.dart';
import 'package:flutter_exercise_4/widgets/newexam.dart';
...
class _MyAppState extends State<MyApp> {
  ...
  @override
  void initState() {
    exams.add(Exam(id: "0", subject: "WP", datetime: DateTime(2022, 6, 6), time: TimeOfDay(hour: 11, minute: 00), duration: 1, latLng: LatLng(41.994529, 21.418588)));
    exams.add(Exam(id: "1", subject: "EMT", datetime: DateTime(2022, 7, 1), time: TimeOfDay(hour: 12, minute: 00), duration: 1, latLng: LatLng(41.994529, 21.418588)));
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
          title: const Text("Exercise 4 & 5 - Student exams"),
          ...
          actions: [
            PopupMenuButton(itemBuilder: (context){
              return [
                ...
                // PopupMenuItem<int>(
                //   value: 3,
                //   child: ElevatedButton.icon(onPressed: () => Navigator.push(context, MaterialPageRoute(builder: ((context) => MapScreen()))), icon: Icon(Icons.logout), label: Text('Log out')),
                // )
              ];
            },
            onSelected: (value){
              ...
              trailing: Row(
                ...
                children: [
                  ...
                  ElevatedButton(
                    ...
                    onPressed: () {
                      Navigator.push(context, MaterialPageRoute(builder: ((context) => MapScreen(destination: e.latLng,))));
                    },
